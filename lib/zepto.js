...
(function($){
  ...
  function add(element, events, fn, selector, getDelegate){
    ...
    eachEvent(events, fn, function(event, fn){
      ...
      e = parse(event);
      if (e.e === 'mouseenter') { e.e = 'mouseover'; proxyfn = mouseEnter(proxyfn); }
      if (e.e === 'mouseleave') { e.e = 'mouseout';  proxyfn = mouseEnter(proxyfn); }
      var handler = $.extend(e, {fn: fn, proxy: proxyfn, sel: selector, del: delegate, i: set.length});
      set.push(handler);
